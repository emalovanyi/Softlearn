...
window.onload = function () { 
    ...
    button.addEventListener("click", function() { 
        ...
        code.innerHTML = "   Яка функція виводить текст на веб-сторінку?<br>"; 
    ...
    var second_quiz = function () { quiz_maker("console.log()", "2", "  Яка функція виводить текст на консоль?<br>", third_quiz, ); } 
    var third_quiz = function () { quiz_maker("alert()", "3", " Яка функція виводить текст у діалоговому вікні?<br> ", fourth_quiz,); } 
    var fourth_quiz = function () { quiz_maker("prompt()", "4", "   Яка функція дозволяє користувачу вводити дані в програму?<br", fifth_quiz,); } 
    
    function fifth_quiz () { 
        answer = "string"; 
        p.innerHTML = "Запитання №5 <br>"; 
        code.innerHTML = "   Дані якого типу можна одержати з функції prompt?"; 
        input.value = ""; 
