...
window.onload = function () { 
    ...
    var second_quiz = function () { quiz_maker("1", "2", "Що виведе наступний код? <br>  var x=2; <br> x**=4;<br> x%=3;<br>  console.log(x)", third_quiz, ); } 
    var third_quiz = function () { quiz_maker("false", "3", " Що виведе наступний код? <br>  var x=false; <br> var y=true; <br>var res= x && y;<br> console.log(res);<br>", fourth_quiz,); } 
    var fourth_quiz = function () { quiz_maker("true", "4", "Що виведе наступний код? <br>  var x=2; <br> var y='2';<br>bool res= x==y; <br> console.log(res)<br>", fifth_quiz,); } 
    
    function fifth_quiz () { 
        answer = "6"; 
        p.innerHTML = "Запитання №5 <br>Що виведе наступний код?"; 
        code.innerHTML = "<br> var x=2; <br> var y=x++; <br>(x+++y);<br>"; 
        input.value = ""; 
