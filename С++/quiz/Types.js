...
window.onload = function () { 
    ...
    button.addEventListener("click", function() { 
        ...
        code.innerHTML = "<br>Який тип має змінна х=7?"; 
    ...
    var second_quiz = function () { quiz_maker("char", "2", "Який тип має змінна х='2'", third_quiz, ); } 
    var third_quiz = function () { quiz_maker("string", "3", " Який тип має змінна х= &ldquo;Hello!&rdquo;?<br>", fourth_quiz,); } 
    var fourth_quiz = function () { quiz_maker("float", "4", "Який тип має змінна x=7,25?<br> ", fifth_quiz,); } 
    
    function fifth_quiz () { 
        answer = "bool"; 
        p.innerHTML = "Запитання №5 <br>Який тип має змінна?"; 
        code.innerHTML = "  х=5=='5' "; 
        input.value = ""; 
